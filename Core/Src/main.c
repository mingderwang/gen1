...
/* Private variables ---------------------------------------------------------*/
/* Definitions for TaskLED2 */
osThreadId_t TaskLED2Handle;
const osThreadAttr_t TaskLED2_attributes = {
  .name = "TaskLED2",
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of TaskLED2 */
  TaskLED2Handle = osThreadNew(StartDefaultTask, NULL, &TaskLED2_attributes);

  /* creation of TaskUART */
  TaskUARTHandle = osThreadNew(StartTask02, NULL, &TaskUART_attributes);
